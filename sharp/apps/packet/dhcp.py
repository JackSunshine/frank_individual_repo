...
class DHCPResponder(app_manager.RyuApp):
    ...
    def assemble_ack(self, pkt):
        ...
        req.options.option_list.insert(0, dhcp.option(tag=3, value=self.bin_server))
        req.options.option_list.insert(0, dhcp.option(tag=6, value=self.bin_dns))
        req.options.option_list.insert(0, dhcp.option(tag=12, value=self.hostname))
        req.options.option_list.insert(0, dhcp.option(tag=54, value=self.bin_server))
